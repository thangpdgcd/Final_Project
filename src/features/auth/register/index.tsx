...
import { register, RegisterPayload, RegisterResponse } from '../../../api/authsapi/authApi';
import './index.scss';
        ...
        <div className="register-hero">
          <div className="register-card">
            ...
            <div className="register-left">
              ...
              <Divider className="divider">{t('auth.registerDivider')}</Divider>
              ...
              >
                ...
                <div className="grid-2">
                  <Form.Item label={t('auth.registerPhoneLabel')} name="phoneNumber">
                ...
                <Form.Item
                  ...
                  hasFeedback
                >
                  <Input.Password className="pc-password" placeholder="••••••••" />
                </Form.Item>
                  ...
                  rules={[
                    ...
                    ({ getFieldValue }) => ({
                      validator(_, value) {
                        ...
                        return Promise.reject(new Error(t('auth.registerConfirmPasswordNotMatch')));
                      },
                    }),
                  ]}
                >
                ...
                <div className="row">
                    ...
                    rules={[
                      {
                        validator: (_, value) =>
                          value
                            ? Promise.resolve()
                            : Promise.reject(new Error(t('auth.registerAgreeRequired'))),
                      },
                    ]}
                    noStyle
                  >
                  ...
                  <Button type="link" className="to-login" onClick={() => navigate('/login')}>
                ...
                <Button type="link" className="btn-login" onClick={() => navigate('/login')}>
