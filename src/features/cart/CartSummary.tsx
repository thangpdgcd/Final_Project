...
const CartSummary: React.FC<Props> = ({ items, onCheckout, onContinueShopping }) => {
  ...
  return (
    <div className="sticky top-28 rounded-3xl border border-stone-200 bg-white p-6 shadow-xl dark:border-stone-800 dark:bg-[#1e1e1e]">
      ...
      <div className="mb-8 flex items-end justify-between overflow-hidden">
      ...
      <div className="mt-auto space-y-3">
        <button
          onClick={onCheckout}
          className="w-full rounded-xl bg-orange-600 px-4 py-4 text-sm font-bold text-white shadow-md transition hover:bg-orange-700 hover:shadow-lg active:scale-95 dark:bg-orange-500 dark:hover:bg-orange-600"
        >
          Checkout Now →
        </button>
        <button
