...
import { CartItemCheckbox } from '@/components/cart/cart-item/CartItemCheckbox';
import { CartItemProductInfo } from '@/components/cart/cart-item/CartItemProductInfo';
import { CartItemUnitPrice } from '@/components/cart/cart-item/CartItemUnitPrice';
import { CartItemQuantityControl } from '@/components/cart/cart-item/CartItemQuantityControl';
import { CartItemAmount } from '@/components/cart/cart-item/CartItemAmount';
import { CartItemActions } from '@/components/cart/cart-item/CartItemActions';
...
const CartItem = React.forwardRef<HTMLDivElement, Props>(({ item, selected, onSelect, onQtyChange, onRemove, isRemoving }, ref) => {
