    ...
    <section className="customer-reviews">
      <div className="customer-reviews__container">
        ...
        >
          ...
          <h2 className="customer-reviews__title">{t('home.reviewsSubtitle')}</h2>
        </motion.div>
        ...
        >
          {reviews.map((review) => (
            ...
            >
              ...
              <div className="customer-reviews__stars">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    size={14}
                    className="customer-reviews__star"
                    fill="currentColor"
                    stroke="currentColor"
                    aria-hidden
                  />
              ...
              <p className="customer-reviews__content">"{t(review.content)}"</p>
              ...
              <div className="customer-reviews__footer">
                ...
                <div className="customer-reviews__profile">
                  <div className="customer-reviews__info">
                    <div className="customer-reviews__author">{t(review.author)}</div>
