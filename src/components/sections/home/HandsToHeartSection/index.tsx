        ...
        <div className='hands-to-heart__grid'>
          <div className='hands-to-heart__content'>
            ...
            <p className='hands-to-heart__desc'>
              Mỗi hạt cà phê bạn thưởng thức đều mang theo câu chuyện của những người nông dân
              Kon Tum cần cù. Họ chăm sóc từng cây cà phê bằng cả tâm hồn, và chúng tôi tiếp
              nối hành trình đó bằng niềm đam mê của những người thợ rang tận tụy.
            </p>
            ...
            <div className='hands-to-heart__author'>
              ...
              <div>
                <div className='hands-to-heart__author-name'>Anh Phan</div>
                <div className='hands-to-heart__author-role'>Người sáng lập Phan Coffee</div>
              </div>
            </div>
          </div>
          ...
          <div className='hands-to-heart__media'>
            <div className='hands-to-heart__media-grid'>
              <img
                ...
                alt='Người nông dân và quả cà phê'
                loading='lazy'
              />
              <img
