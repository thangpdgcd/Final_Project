...
const ExploreFlavorsSection: React.FC = () => {
  ...
  const items = [
    {
      title: t('home.explore.items.singleOrigin.title'),
      desc: t('home.explore.items.singleOrigin.desc'),
    ...
    {
      title: t('home.explore.items.houseBlends.title'),
      desc: t('home.explore.items.houseBlends.desc'),
    ...
    {
      title: t('home.explore.items.brewingTools.title'),
      desc: t('home.explore.items.brewingTools.desc'),
    ...
    <section className="explore-flavors">
      <div className="explore-flavors__container">
        <div className="explore-flavors__header">
          <h2 className="explore-flavors__title">{t('home.explore.title')}</h2>
