...
import { selectCartItemsByUserId } from '@/redux/selectors';
...
const HeaderPage: React.FC = () => {
  ...
  const cartItems = useAppSelector((s) => selectCartItemsByUserId(s, effectiveUserId));
  ...
  useEffect(() => {
    ...
    void dispatch(fetchCartByUserId(effectiveUserId));
