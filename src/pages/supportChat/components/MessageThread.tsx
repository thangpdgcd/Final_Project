...
export const MessageThread: React.FC<Props> = ({ myUserId, messages, loading }) => {
  ...
  return (
    <div
      ref={containerRef}
      className="flex-1 overflow-auto p-4 space-y-2 bg-[radial-gradient(circle_at_20%_20%,rgba(255,255,255,0.06)_0%,rgba(0,0,0,0)_45%),radial-gradient(circle_at_80%_0%,rgba(8,102,255,0.10)_0%,rgba(0,0,0,0)_55%)]"
    >
      {sorted.length === 0 ? (
