...
import { ProfileCard, MenuCard } from '@/pages/users/profile';
...
const ProfilePage: React.FC = () => {
  ...
  const voucherVault = useVoucherVaultStore((s: any) => s.vouchers);
  const hydrateVoucherVault = useVoucherVaultStore((s: any) => s.hydrate);
  const removeVaultVoucher = useVoucherVaultStore((s: any) => s.remove);
  const clearVault = useVoucherVaultStore((s: any) => s.clear);
