...
const COFFEE_DATA: CoffeeExperience = {
  ...
  basePrice: 450000,
  description:
    'Our Signature Highlands Blend is crafted for those who appreciate complexity. A dark roast that brings out nutty undertones with a subtle cocoa finish.',
...
const REVIEWS: Review[] = [
  {
    ...
    user: 'Linh Nguyen',
    rating: 5,
    comment: 'The best subscription I have ever had. The freshness is unbeatable!',
    date: '2 days ago',
    verified: true,
  },
  {
    ...
    user: 'David Pham',
    rating: 4,
    comment: 'Great roast level. I prefer the Ground version for my moka pot.',
    date: '1 week ago',
    verified: true,
  },
];
        ...
        <div className="lg:col-span-7 space-y-12">
          ...
          <section className="space-y-8 bg-white/50 p-8 rounded-[40px]">
            <div className="flex items-center justify-between">
              ...
              <Button type="link" className="font-bold text-[#6f4e37]">
                See All 128 Reviews <ChevronRight className="w-4 h-4 inline" />
              </Button>
            </div>
          ...
          <div className="sticky top-28 space-y-6">
            <div className="bg-white rounded-[40px] p-8 shadow-2xl border-4 border-white">
              ...
              <div className="space-y-4 mb-10">
                ...
                >
                  {purchaseType === 'subscribe' && (
                    <div className="absolute top-0 right-6 translate-y-[-50%] bg-[#6f4e37] text-white px-4 py-1 rounded-full text-[10px] font-black tracking-widest">
                      RECOMMENDED
                    </div>
                  )}
                  <div className="flex items-center justify-between">
              ...
              <div className="pt-8 border-t border-gray-100">
                ...
                <div className="mt-6 flex items-center justify-center gap-6 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">
                  <div className="flex items-center gap-1">
                    <Truck size={14} /> Free Express
                  </div>
                  <div className="flex items-center gap-1">
                    <ShieldCheck size={14} /> Safe Payment
                  </div>
                </div>
              </div>
            </div>
