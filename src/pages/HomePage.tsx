    ...
    <Content className="homepage__content">
      ...
      <div id="home-content">
        <Suspense fallback={null}>
          <SectionWrapper><ExploreFlavorsSection /></SectionWrapper>
          <SectionWrapper><FeaturedProductSection /></SectionWrapper>
          <SectionWrapper><ArtisticRoastingSection /></SectionWrapper>
          <SectionWrapper><HandsToHeartSection /></SectionWrapper>
        </Suspense>
      </div>
      <SectionWrapper><RoastingProcessSection /></SectionWrapper>
      <SectionWrapper><ReviewsSection /></SectionWrapper>
      <SectionWrapper><ClubCtaSection /></SectionWrapper>
      <Chatbox />
    </Content>
  );
};
