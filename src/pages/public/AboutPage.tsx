...
const IMG_PHIN = cloudinaryImg('v1768823885/492005643_716963337517931_4130308983468400647_n_sc00pf.jpg');
...
const AboutPage: React.FC = () => {
  ...
  return (
    <div className="about-page about-page--bg-animate bg-[color:var(--hl-surface)] text-[color:var(--hl-on-surface)]">
        ...
        <div className="flex flex-col gap-12 lg:flex-row lg:items-stretch lg:gap-12 xl:gap-16">
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 sm:gap-4">
              <button type="button" className="btn-highland-primary" onClick={() => navigate('/products')}>
                {t('aboutPage.heroCtaPrimary')}
              </button>
              <button type="button" className="btn-highland-ghost inline-flex items-center gap-1" onClick={scrollToOrigin}>
        ...
        <div className="relative z-[1] max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-20 items-stretch">
            ...
            >
              ...
              <div className="w-12 h-0.5 bg-[color:color-mix(in_srgb,var(--hl-primary)_85%,transparent)] mb-8 rounded-full" aria-hidden />
      ...
      {/* Collections */}
      <section className="py-20 lg:py-28 px-5 sm:px-8 lg:px-12" aria-labelledby="about-collections-heading">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
            ...
            >
              ...
              >
                ...
                <div className="relative z-[1] h-full min-h-[inherit] flex flex-col justify-end p-6 sm:p-8">
                  <p className="text-white text-2xl sm:text-3xl font-medium mb-3 max-w-[14ch] transition-[letter-spacing] duration-300 group-hover:tracking-wide" style={{ fontFamily: 'var(--font-highland-display)' }}>
            ...
            >
              ...
              >
                ...
                <div className="relative z-[1] h-full min-h-[inherit] flex flex-col justify-end p-6 sm:p-8">
                  <p className="text-white text-xl sm:text-2xl font-medium mb-2 transition-[letter-spacing] duration-300 group-hover:tracking-wide" style={{ fontFamily: 'var(--font-highland-display)' }}>
            ...
            >
              ...
              >
                <div className="w-12 h-12 rounded-md bg-[color-mix(in_srgb,var(--hl-primary)_10%,transparent)] flex items-center justify-center text-[color:var(--hl-primary)] mb-6 transition-[transform,background-color] duration-500 ease-out group-hover:scale-110 group-hover:bg-[color-mix(in_srgb,var(--hl-primary)_18%,transparent)] motion-reduce:group-hover:scale-100">
                  <Truck className="w-6 h-6 transition-transform duration-500 group-hover:-translate-y-0.5 motion-reduce:group-hover:translate-y-0" strokeWidth={1.5} aria-hidden />
                </div>
                <h3 className="text-[color:var(--hl-primary)] text-2xl font-medium mb-3" style={{ fontFamily: 'var(--font-highland-display)' }}>
            ...
            >
              ...
              >
                ...
                <div className="relative z-[1] h-full min-h-[inherit] flex flex-col justify-end p-6 sm:p-8">
                  <p className="text-white text-2xl sm:text-3xl font-medium mb-2 max-w-[16ch] transition-[letter-spacing] duration-300 group-hover:tracking-wide" style={{ fontFamily: 'var(--font-highland-display)' }}>
      ...
      >
        <motion.div initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
          ...
          <p className="hl-sans text-white/85 mb-10 max-w-xl mx-auto leading-relaxed">{t('aboutPage.cta.subtitle')}</p>
          <button type="button" className="btn-highland-on-gradient" onClick={() => navigate('/products')}>
